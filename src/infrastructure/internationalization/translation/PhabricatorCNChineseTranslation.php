  ...
  protected function getTranslations() {
    return array(
      ...
      '%d Assigned Task(s)' => array(
       ...
       'PHP Profiling Tool'=> array(
           'PHP调优工具',
           'PHP调优工具',
       ),
       'Visual PHP Parser'=> array(
           '可视化PHP解析器',
           '可视化PHP解析器'
       ),
       'Visual PHP Parser'=> array(
       ...
       'Developer UI Examples'=> array(
           '开发者 UI示例',
           '开发者 UI示例'
       ),
        'Configure Phabricator'=> array(
           '配置 Phabricator',
           '配置 Phabricator'
       ),
        'Tasks and Bugs'=>array(
            '任务和 BUG',
            '任务和 BUG'
        ),
        'Host and Browse Repositories'=>array(
          '托管和浏览代码库',
           '托管和浏览代码库' 
        ),
